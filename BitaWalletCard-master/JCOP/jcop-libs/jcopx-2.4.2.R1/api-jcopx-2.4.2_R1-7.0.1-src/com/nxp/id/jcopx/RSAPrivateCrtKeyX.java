 ...
 ********************************************************************************
 *                                                                              *
 *   @module           $RCSfile: RSAPrivateCrtKeyX.java.rca $
 *   @revision         $Revision: 1.1 $
 *   @date             $Date: Wed Jun  2 20:10:24 2010 $
 *                                                                              *
 *   @description                                                               *
 *                                                                              *
 *   This class contains the API of the extension of RSAPrivateCrtKey.          *
 ********************************************************************************/
...
/**
 * The RSAPrivateCrtKeyX class is an extension of RSAPrivateCrtKey class, which also allow the setting
 * of the public exponent.
 *
 * @see RSAPrivateCrtKey
 */
public interface RSAPrivateCrtKeyX extends RSAPrivateCrtKey
{
    /**
